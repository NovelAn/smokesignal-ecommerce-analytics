...
8. 退款率判断必须保守：男装奢品退换货率通常 10-20%（高客单、试穿退换正常），退款率 < 20% 属正常范围，不要标"高退款率"；退款率 20-25% 可标"退款偏高"；> 25% 才可标"高退款率"。
...
{{
  ...
  "key_interests": ["2-4 个**短语标签**（2-6 字），如'大促心智'/'折扣驱动'/'正价主导'/'高频复购'/'高连带'/'批量囤货'/'Total Look'/'成衣主导'/'烟具专注'/'静默下单'/'参数党'/'直接决策'/'品质优先'/'价格不敏感'/'新品尝鲜'/'跨年复购'/'活跃高频'/'直播互动'/'售后敏感'/'节日礼赠'，覆盖购买行为/品类/沟通/价值四类，不写完整句子"],
  "pain_points": ["1-3 个**短语标签**（2-6 字），如'退款偏高'/'VIP漏升'/'折扣依赖'/'品类单一'/'尺码困扰'/'库存焦虑'/'流失风险'/'缺聊天数据'/'沟通少'/'无售前'/'价格观望'/'AOV偏低'/'品牌认知弱'/'首单未复购'/'跨品类弱'，覆盖财务/行为/数据/风险四类，不写完整句子"],
