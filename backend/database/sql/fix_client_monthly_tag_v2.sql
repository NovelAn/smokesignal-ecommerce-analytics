...
BEGIN
    ...
    INNER JOIN (
        ...
        JOIN tmp_latest_tags latest ON tb_buyer.buyer_nick = latest.buyer_nick
        GROUP BY tb_buyer.buyer_nick, tb_buyer.buyer_type, tb_buyer.is_smoker, tb_buyer.is_vic, latest.client_monthly_tag
